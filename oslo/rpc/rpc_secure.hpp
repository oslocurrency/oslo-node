...
{
/**
 * Specialization of oslo::rpc with TLS support
 */
class rpc_secure : public rpc
{
public:
	rpc_secure (boost::asio::io_context & context_a, oslo::rpc_config const & config_a, oslo::rpc_handler_interface & rpc_handler_interface_a);
