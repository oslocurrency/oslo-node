...
oslo::rpc::rpc (boost::asio::io_context & io_ctx_a, oslo::rpc_config const & config_a, oslo::rpc_handler_interface & rpc_handler_interface_a) :
config (config_a),
acceptor (io_ctx_a),
...
void oslo::rpc::accept ()
{
	auto connection (std::make_shared<oslo::rpc_connection> (config, io_ctx, logger, rpc_handler_interface));
...
std::unique_ptr<oslo::rpc> oslo::get_rpc (boost::asio::io_context & io_ctx_a, oslo::rpc_config const & config_a, oslo::rpc_handler_interface & rpc_handler_interface_a)
{
