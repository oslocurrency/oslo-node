...
namespace ipc
{
	/** Produces Oslo API compliant Flatbuffers from objects and builders */
	...
	public:
		...
		{
			oslo::ipc::flatbuffer_producer producer;
		...
		auto make_envelope (flatbuffers::Offset<T> obj)
		{
			...
			osloapi::EnvelopeBuilder envelope_builder (*fbb);
			...
			envelope_builder.add_message_type (osloapi::MessageTraits<T>::enum_value);
