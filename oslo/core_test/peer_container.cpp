...
TEST (peer_container, empty_peers)
{
	...
	oslo::network & network (system.nodes[0]->network);
...
TEST (peer_container, no_recontact)
{
	...
	oslo::network & network (node1.network);
	auto observed_peer (0);
	auto observed_disconnect (false);
	oslo::endpoint endpoint1 (boost::asio::ip::address_v6::loopback (), 10000);
	ASSERT_EQ (0, network.size ());
	network.channel_observer = [&observed_peer](std::shared_ptr<oslo::transport::channel>) { ++observed_peer; };
...
TEST (peer_container, reserved_peers_no_contact)
{
	...
	ASSERT_EQ (nullptr, channels.insert (oslo::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0x00000001)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (oslo::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xc0000201)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (oslo::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xc6336401)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (oslo::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xcb007101)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (oslo::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xe9fc0001)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (oslo::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xf0000001)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (oslo::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xffffffff)), 10000), 0));
...
TEST (peer_container, split)
{
	...
	oslo::endpoint endpoint1 (boost::asio::ip::address_v6::loopback (), 100);
	oslo::endpoint endpoint2 (boost::asio::ip::address_v6::loopback (), 101);
...
{
	oslo::system system (1);
	std::array<oslo::endpoint, 8> target;
	std::fill (target.begin (), target.end (), oslo::endpoint (boost::asio::ip::address_v6::loopback (), 10000));
	system.nodes[0]->network.random_fill (target);
	ASSERT_TRUE (std::all_of (target.begin (), target.end (), [](oslo::endpoint const & endpoint_a) { return endpoint_a == oslo::endpoint (boost::asio::ip::address_v6::any (), 0); }));
}
...
TEST (channels, fill_random_full)
{
	...
	{
		system.nodes[0]->network.udp_channels.insert (oslo::endpoint (boost::asio::ip::address_v6::loopback (), i), 0);
	}
	std::array<oslo::endpoint, 8> target;
	std::fill (target.begin (), target.end (), oslo::endpoint (boost::asio::ip::address_v6::loopback (), 10000));
	system.nodes[0]->network.random_fill (target);
	ASSERT_TRUE (std::none_of (target.begin (), target.end (), [](oslo::endpoint const & endpoint_a) { return endpoint_a == oslo::endpoint (boost::asio::ip::address_v6::loopback (), 10000); }));
}
...
TEST (channels, fill_random_part)
{
	...
	{
		system.nodes[0]->network.udp_channels.insert (oslo::endpoint (boost::asio::ip::address_v6::loopback (), i + 1), 0);
	}
	std::fill (target.begin (), target.end (), oslo::endpoint (boost::asio::ip::address_v6::loopback (), 10000));
	system.nodes[0]->network.random_fill (target);
	ASSERT_TRUE (std::none_of (target.begin (), target.begin () + half, [](oslo::endpoint const & endpoint_a) { return endpoint_a == oslo::endpoint (boost::asio::ip::address_v6::loopback (), 10000); }));
	ASSERT_TRUE (std::none_of (target.begin (), target.begin () + half, [](oslo::endpoint const & endpoint_a) { return endpoint_a == oslo::endpoint (boost::asio::ip::address_v6::loopback (), 0); }));
	ASSERT_TRUE (std::all_of (target.begin () + half, target.end (), [](oslo::endpoint const & endpoint_a) { return endpoint_a == oslo::endpoint (boost::asio::ip::address_v6::any (), 0); }));
}
...
TEST (peer_container, list_fanout)
{
	...
	auto add_peer = [&node](const uint16_t port_a) {
		ASSERT_NE (nullptr, node.network.udp_channels.insert (oslo::endpoint (boost::asio::ip::address_v6::loopback (), port_a), node.network_params.protocol.protocol_version));
	};
	add_peer (9998);
...
TEST (peer_container, depeer)
{
	...
	oslo::message_buffer buffer = { bytes->data (), bytes->size (), endpoint0 };
	system.nodes[0]->network.udp_channels.receive_action (&buffer);
	ASSERT_EQ (1, system.nodes[0]->stats.count (oslo::stat::type::udp, oslo::stat::detail::outdated_version));
}
