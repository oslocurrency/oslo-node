...
{
	oslo::signature_checker checker (0);
	oslo::signature_check_set check = { 0, nullptr, nullptr, nullptr, nullptr, nullptr };
...
{
	oslo::signature_checker checker (4);
	...
	auto signature_checker_work_func = [&checker]() {
		...
		oslo::state_block invalid_block (key.pub, 0, key.pub, 0, 0, key.prv, key.pub, 0);
		...
		std::vector<oslo::signature_check_set> signature_checker_sets;
...
TEST (signature_checker, boundary_checks)
{
	...
	oslo::signature_checker checker (1);
