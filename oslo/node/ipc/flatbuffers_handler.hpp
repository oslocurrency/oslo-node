...
namespace ipc
{
	 ...
	 * @throws Methods of this class throw oslo::error on failure.
	...
	public:
		 ...
		 */
		flatbuffers_handler (oslo::node & node_a, oslo::ipc::ipc_server & ipc_server_a, std::shared_ptr<oslo::ipc::subscriber> const & subscriber_a, oslo::ipc::ipc_config const & ipc_config_a);
		 ...
		 */
		static std::shared_ptr<flatbuffers::Parser> make_flatbuffers_parser (oslo::ipc::ipc_config const & ipc_config_a);
	...
	private:
		...
		oslo::ipc::ipc_config const & ipc_config;
	};
}
}
