...
public:
	timer () = default;
	timer (oslo::timer_state state_a, std::string const & description_a = "timer");
	...
	oslo::timer_state current_state () const;

private:
	timer * parent{ nullptr };
	std::vector<timer> children;
	oslo::timer_state state{ oslo::timer_state::stopped };
	std::string desc;
