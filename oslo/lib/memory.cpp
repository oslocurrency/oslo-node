...
bool oslo::get_use_memory_pools ()
{
	return use_memory_pools;
}

/** This has no effect on Mac */
void oslo::set_use_memory_pools (bool use_memory_pools_a)
{
#ifndef __APPLE__
...
oslo::cleanup_guard::cleanup_guard (std::vector<std::function<void()>> const & cleanup_funcs_a) :
